...
struct Base {
	typedef enum {
		...
		ET_BOUNDARIES=0x4, ET_LANDUSE=0x8, ET_NATURAL=0x10, ET_AREA=0x20, ET_BUILDING=0x20|0x40, ET_ISLAND=0x80,
		ET_MULTIPOLYGONS=0x100,
		ET_ALL_SPECIAL_BUT_BUILDINGS=ET_BOUNDARIES|ET_LANDUSE|ET_NATURAL|ET_AREA|ET_ISLAND|ET_PRIMITIVE_WAYS|ET_PRIMITIVE_RELATIONS,
